webpackJsonp([0], [, , , , , , function(t, e, n) {
    ...
    function(t, e) {
        t.exports = ["teraz", ["%s sek temu", "%s sek temu"],
            ["%s minut", "%s minut"],
            ["%s godz.", "%s godz."],
            ["%s dni", "%s dni"],
            ["%s tyg.", "%s tyg."],
        ...
        var s = n(31),
            ...
            r = {
                ...
                appelsDisplayName: function(t, e) {
                    if (!0 === t.appelsInfo.hidden) return "Dzwoni Anonimowo";
            ...
            methods: {
                onSelect: function(t) {
                    ...
                    !0 !== this.ignoreControls && (this.ignoreControls = !0, l.a.CreateModal({
                        ...
                        e.ignoreControls = !1, "Cofnij" !== t.title && (e.$phoneAPI.callEvent(t.eventName, t.type), e.$router.push({
                            name: "home"
                        }))
                    }))
                }
            ...
            methods: i()({}, n.i(r.a)(["setMessageRead", "sendMessage", "deleteMessage"]), {
                ...
                onActionMessage: function() {
                    ...
                    if (!0 === n && (i = [{
                        ...
                        else if ("Zaznacz na mapie" === n.title) {
                ...
                onRight: function() {
                    ...
                    !0 !== this.ignoreControls && -1 === this.selectMessage && (this.ignoreControls = !0, h.a.CreateModal({
                        ...
                        "Wyślij lokalizację" === e.title && t.sendMessage({
                            phoneNumber: t.phoneNumber,
                            message: "%pos%"
                        }), t.ignoreControls = !1
                    }))
                ...
                resetPhone: function(t, e) {
                    ...
                    if ("Anuluj" !== e.title) {
                        ...
                        d.a.CreateModal({
                            ...
                            n.ignoreControls = !1, "Resetuj" === t.title && n.$phoneAPI.deleteALL()
                        })
                    }
                }
            }),
        ...
        t.exports = {
            render: function() {
                ...
                return n("div", {
                    ...
                    staticClass: "bar"
                }), t._v(" "), n("label", [t._v("Nazwa")])]), t._v(" "), n("div", {
