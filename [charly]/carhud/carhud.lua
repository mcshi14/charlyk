...
Citizen.CreateThread(function()
	...
	--  ####         	 PLANE HUD	  	  	  ####  --
			...
			if PedHeli then
				...
				if HUDPlane.Panel then
					...
					elseif (MainRotor > 0) and (MainRotor < 150) then
					...
					elseif (TailRotor > 0) and (TailRotor < 150) then
	...
	--  ####         	 PLANE HUD	  	  	  ####  --			
			if HUD.Indicators and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
			...
			if HUD.CarRPM and (model ~= 13) and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
			...
			if HUD.CarGears and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
			...
			if HUD.Speed == 'kmh' and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
			...
			if HUD.Cruise and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
			...
			if HUD.Top and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
			...
			if HUD.Engine and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
				if EngineRunning then
			...
			if HUD.SpeedIndicator and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
			...
			if HUD.DamageSystem and driverseat and PedHeli == false and PedPlane == false and PedBoat == false then
